            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Teachers Details</a>
                        </li>
                                ...
                                <div class="tab-inn">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="teachers_id" class="validate">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="input-field col s6">
                                                <input type="text" value="" name="salary" class="validate" required>
