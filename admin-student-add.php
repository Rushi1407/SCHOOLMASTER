                                    ...
                                    <form action="insertstudent.php" method="post">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" class="validate" name="fname" required>
                                                <label class="">First name</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="lname" class="validate" required>
                                                <label class="">Last name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="number" value="" name="number1" class="validate" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="medical_info" class="validate">
                                                <label class="">medical_info</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="gender" class="validate">
                                                <label class="">Gender</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" value="" name="dob" class="validate">
