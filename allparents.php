                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-users" aria-hidden="true"></i> Students</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="allstudents.php">Delete Parents</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                            ...
                                            ?>
                                                <tr>
                                                   <td><?php echo $row["parent_id"]; ?></td>
													...
													<td><a href="updateparents.php" class="ad-st-view">Update</a></td>
                                                    <td><a href="deleteparents.php?parent_id=<?php echo $row["parent_id"]; ?>"class="ad-st-view">Delete</a></td>
                                                </tr>
